...
void BLEDevice::startAdvertisingDirected(std::string stringAddress) {
	log_v(">> startAdvertising");
	BLEAdvertising* advertisement = getAdvertising();
	advertisement->directed_advertisement(stringAddress);
	advertisement->start();
	log_v("<< startAdvertising");
} // startAdvertising

void BLEDevice::startAdvertisingWithManufData(uint8_t *manuf_data) {
	log_v(">> startAdvertising");
	BLEAdvertising* advertisement = getAdvertising();
	advertisement->wake_advertisement(manuf_data);
	advertisement->start();
	log_v("<< startAdvertising");
} // startAdvertising
