...
void BLEAdvertising::directed_advertisement(std::string stringAddress){
	// m_advParams.adv_type          = ADV_TYPE_DIRECT_IND_HIGH;
	// m_advParams.adv_filter_policy = ADV_FILTER_ALLOW_SCAN_ANY_CON_ANY;
	// m_advParams.peer_addr    	  = BLEAddress(stringAddress);
	// m_advParams.peer_addr_type    = BLE_ADDR_TYPE_PUBLIC;
} // BLEAdvertising

void BLEAdvertising::wake_advertisement(uint8_t *manuf_data){
	...
	m_advData.p_manufacturer_data = manuf_data;
	// m_advData.appearance 		  = 0x004c;
